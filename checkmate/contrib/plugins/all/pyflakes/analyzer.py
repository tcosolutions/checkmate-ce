...
class PyFlakesAnalyzer(BaseAnalyzer):
    ...
    def analyze(self, file_revision):
        ...
        pyflakes_check(file_revision.get_file_content(),
                       file_revision.path, reporter)
...
class Reporter(BaseReporter):
    ...
    def unexpectedError(self, filename, msg):
        issue = {
            'code': '0000',
            'data': {'description': str(msg, errors='ignore')},
            'location': (),
    ...
    def syntaxError(self, filename, msg, lineno, offset, text):
        ...
        issue = {
            ...
            'type': 'syntax error',
            'level': 'error',
            'data': {'description': str(msg, errors='ignore'), 'text': str(text, errors='ignore')},
            'location': location,
        }
        self._issues.append(issue)
